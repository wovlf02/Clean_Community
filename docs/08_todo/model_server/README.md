...
- [ ] 단일 텍스트 분석 API (`POST /analyze`)
- [ ] 배치 텍스트 분석 API (`POST /analyze/batch`)
- [ ] 헬스체크 API (`GET /health`)
- [ ] 에러 핸들링 및 응답 스키마
- [ ] Rate Limiting 적용
...
| 버전 | 목표 | 예정일 |
|------|------|--------|
| v0.1.0 | FastAPI 기본 구조 + 모델 로딩 | TBD |
| v0.2.0 | API 엔드포인트 완성 | TBD |
| v0.3.0 | Next.js 연동 완료 | TBD |
| v1.0.0 | AWS 배포 + 프로덕션 준비 | TBD |
